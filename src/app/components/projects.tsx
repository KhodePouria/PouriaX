...
import firs from "@/app/public/shopify/hero.png"
type project = {
    key: number,
    name: string,
    descryption? : string,
        ...
        <div className="flex flex-col">
            ...
            {Projects.map((p:project)=>(
                <div key={p.key} 
                    ...
                    <Image src={p.pic} alt="pic" width={1080} height={720} className="object-cover rounded-xl w-[330px] h-[170px] hover:w-[990px] hover:h-[425px] hover:transition-all"></Image>
